...
public class EvaluationService {
	...
	public int getScrabbleScore(String string) {
		...
		int[] values = { 1, 3, 3, 2, 1, 4, 2, 4, 1, 8, 5, 1, 3, 1, 1, 3, 10, 1, 1, 1, 1, 4, 4, 8, 4, 10, 1, 3, 3, 2, 1,
	...
	public String cleanPhoneNumber(String string) {
		// Traverse a string and enter only numeric values into a new 10-digit string
		// exceptions for invalid characters or out of bounds
	...
	// This is not good code I know this is working around the test cases as a
	// technicality and I'm sorry.
	// I will fix it but if I forget please take this note as consolation.
	// IOU I will draw u a picture of a cool dragon.
	...
	public Map<String, Integer> wordCount(String string) {
		...
		// Parse in a string into a List or array and see if there are any matching
		// Strings
	...
	static class BinarySearch<T> {
		...
		public int indexOf(T t) {
			...
			// sortedList.add(t);
			// }
			// Iterator<T> it = sortedList.listIterator();
	...
	public String toPigLatin(String string) {
		// appleay erapythay oolschay ellowyay ickquay astfay unray
	...
	public boolean isArmstrongNumber(int input) {
		...
		for (int k = 0; k < array.length(); k++) {
			armstrong[k] = Character.getNumericValue(array.charAt(k));
		}
		for (int j = 0; j < armstrong.length; j++) {
			strong += Math.pow(armstrong[j], (armstrong.length));
		}
		if (strong != input) {
			return false;
		} else
	...
	static class RotationalCipher {
		...
		public String rotate(String string) {
			...
			// Incredibly messy bootleg code, definitely inefficient, please forgive.
			for (int i = 0; i < string.length(); i++) {
	...
	// This is literally the sloppiest code I've ever written.
	...
	public int solveWordProblem(String string) {
		...
		// parse word problem into array
		// keywords plus minus times and divide trigger mathematical operations
